...
// NDF (Concentration of reflection vector)
...
void main()
{
    ...
    // vec3 ambient = vec3(0.03) * albedo * ao; // NO IBL
    ...
    // IBL WAY: SPECULAR
    const float MAX_REFLECTION_LOD = 4.0; // 0 ~ 4 (5 roughness (mipmap) levels)
